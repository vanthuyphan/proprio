...
export async function initCommand(): Promise<void> {
  ...
  console.log("\nNext steps:");
  console.log("  1. Install the SDK: npm install meta-harness");
  console.log("  2. Add tracking to your app:");
  console.log('     import { MetaHarness } from "meta-harness";');
  console.log("     const harness = new MetaHarness();");
  console.log('     harness.trackUsage("feature.name", userId);');
  console.log("  3. Run analysis: npx meta-harness analyze");
}
